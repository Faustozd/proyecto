...
class PortScanner:
    ...
    def scan(self):
        ...
        results = {
            ...
            'vulnerabilidades': {
                'labels': ["SQL Injection", "Cross-site scripting", "Buffer Overflow"],
                'data': [5, 3, 1]  # Ejemplo estático, puedes modificar según tus necesidades
            },
            'ipsMaliciosas': {
                'labels': ["192.168.1.1", "10.0.0.1", "172.16.0.1"],
                'data': [2, 1, 3]  # Ejemplo estático
            },
